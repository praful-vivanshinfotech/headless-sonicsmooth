  ...
  return (
    <div className="max-w-[780px] mx-auto sm:p-6">
      <div className="max-w-[275px] mx-auto">
        <img alt="" src="/images/afterpay.png" className=" mx-auto" />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 items-end gap-4">
        <div>
          <div className="flex flex-col justify-center items-center">
            <div>
              <img alt="" src="/images/bag.png" className=" mx-auto" />
            </div>
            <p className="text-center font-600 px-1 pt-4">
        ...
        <div>
          <div className="flex flex-col justify-center items-center">
            <div>
              <img alt="" src="/images/chain-laptop.png" className=" mx-auto" />
            </div>
            <p className="text-center font-600 px-1 pt-4">
              Add your favorites to cart
            </p>
        ...
        <div>
          <div className="flex flex-col justify-center items-center">
            <div>
              <img alt="" src="/images/circle.png" className=" mx-auto" />
            </div>
            <p className="text-center font-600 px-1 pt-4">
              Add your favorites to cart
            </p>
